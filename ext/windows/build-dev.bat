...
nuget restore "sdk-dev\Adjust\Adjust.sln"

ECHO.
ECHO ============== Making the Adjust SDK DLLs ...
devenv "sdk-dev\Adjust\Adjust.sln" /build Debug

ECHO.
ECHO ============== Copying needed Adjust SDK DLLs ...
ECHO f | xcopy /f /y sdk-dev\WindowsPcl\bin\Debug\WindowsPcl.dll bridge\adjust-dlls\WindowsPcl.dll
ECHO f | xcopy /f /y sdk-dev\WindowsUap\bin\Debug\WindowsUap.dll bridge\adjust-dlls\WindowsUap.dll
ECHO f | xcopy /f /y sdk-dev\WindowsUAP10\bin\Debug\AdjustUAP10.dll bridge\adjust-dlls\AdjustUAP10.dll
ECHO f | xcopy /f /y sdk-dev\WindowsStore\bin\Debug\AdjustWS.dll bridge\adjust-dlls\AdjustWS.dll
ECHO f | xcopy /f /y sdk-dev\WindowsPhone81\bin\Debug\AdjustWP81.dll bridge\adjust-dlls\AdjustWP81.dll
REM ---- Integration Testing dll - Test Library
ECHO f | xcopy /f /y sdk-dev\IntegrationTesting\TestLibrary\bin\Debug\TestLibrary.dll bridge\adjust-dlls\TestLibrary.dll
