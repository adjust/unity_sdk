...
echo -e "${CYAN}[ADJUST][IOS][BUILD]:${GREEN} Building AdjustStatic framework target ... ${NC}"
...
echo -e "${CYAN}[ADJUST][IOS][BUILD]:${GREEN} Building AdjustTestLibraryStatic framework target ... ${NC}"
